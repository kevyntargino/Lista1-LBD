...
--
-- Host: mysql:3306
-- Tempo de geração: 01/09/2025 às 18:24
...
--
ALTER TABLE `Turma`
  ADD CONSTRAINT `Turma_ibfk_1` FOREIGN KEY (`disciplina_sigla`) REFERENCES `Disciplina` (`sigla`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
