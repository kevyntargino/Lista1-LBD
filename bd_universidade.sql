...
--
-- Estrutura para tabela `requisito_disciplina`
--

CREATE TABLE `requisito_disciplina` (
  `sigla_disciplina` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `sigla_pre_requisito` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
ALTER TABLE `requisito_disciplina`
  ADD KEY `fk_disciplina_requisito` (`sigla_disciplina`),
  ADD KEY `fk_requisito_disciplina` (`sigla_pre_requisito`);
...
--
ALTER TABLE `requisito_disciplina`
  ADD CONSTRAINT `fk_disciplina_requisito` FOREIGN KEY (`sigla_disciplina`) REFERENCES `disciplinas` (`sigla`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `fk_requisito_disciplina` FOREIGN KEY (`sigla_pre_requisito`) REFERENCES `disciplinas` (`sigla`) ON DELETE RESTRICT ON UPDATE RESTRICT;
